...
- Strong preferences for visual direction? (minimal, bold, elegant, playful, technical, organic)
...
Skip questions where the answer is clear from the codebase.

## Step 3: Write Design Context

Synthesize findings into a `## Design Context` section:
...
Then ask whether they'd also like the Design Context appended to CLAUDE.md. If yes, append or update the section there as well.

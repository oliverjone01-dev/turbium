...
## TURBIUM: виральные механики (обязательно)

При проектировании любого контент-юнита читай `.claude/skills/viral-mechanics/SKILL.md`. Твоя зона: открытые петли (Зейгарник) на каждом слайде, паттерн-прерывание обложек, share-механика ДО контента (что перешлют и почему), библиотека кейсов блока 2 (Wrapped-карточки результата, участие как у Ice Bucket, серийность как у Blendtec). Чек-лист супер-виральности: порог 8/10.

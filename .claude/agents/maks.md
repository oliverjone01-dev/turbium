...
При написании любого текста читай `.claude/skills/viral-mechanics/SKILL.md`. Твоя зона: скользкая горка Шугермана (первое предложение только ради второго), семена любопытства в конце каждого блока, «ты»-фокус дословными фразами ЦА из research-базы, конкретика вместо прилагательных, заголовки-парадоксы для лонгридов. Чек-лист супер-виральности: порог 8/10.
